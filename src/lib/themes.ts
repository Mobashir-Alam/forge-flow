...
export const THEMES: Theme[] = [
  ...
  },
  {
    id: "sky-ocean",
    name: "Sky Ocean",
    description: "Minimal light sky-blue ocean breeze",
    mode: "light",
    preview: ["#f0f9ff", "#e0f2fe", "#38bdf8", "#0284c7"],
    tokens: light({
      background: "200 100% 98%",
      card: "0 0% 100%",
      popover: "0 0% 100%",
      foreground: "210 50% 18%",
      "card-foreground": "210 50% 18%",
      secondary: "200 80% 95%",
      "secondary-foreground": "210 50% 20%",
      muted: "200 60% 96%",
      "muted-foreground": "210 25% 48%",
      primary: "200 90% 50%",
      "primary-foreground": "0 0% 100%",
      accent: "190 85% 55%",
      ...
      "sidebar-foreground": "210 50% 18%",
      "sidebar-primary": "200 90% 50%",
      "sidebar-primary-foreground": "0 0% 100%",
      "sidebar-accent": "200 80% 95%",
      "sidebar-accent-foreground": "210 50% 18%",
      "sidebar-border": "200 60% 90%",
      "sidebar-ring": "200 90% 50%",
    }),
    gradientPrimary: "linear-gradient(135deg, hsl(200 90% 60%), hsl(190 85% 65%))",
    shadowGlow: "0 0 30px hsl(200 90% 60% / 0.18)",
  },
  {
    id: "soft-pastel",
    name: "Soft Pastel",
